...
| `client/src/components/Chat/ChatWindow.jsx` | 종료 세션에 "이어서 대화" 버튼 추가 |
...
│   │   ├── stores/                 # Zustand (authStore, sessionStore, themeStore)
│   │   ├── App.jsx
│   │   ├── main.jsx
│   │   └── index.css
│   ├── index.html
...
| **2.6차 — 세션 지속성** | 세션 자동 이름 (첫 메시지 기반), 세션 재개 (`--resume`), claude_session_id DB 영속화 | **완료** |
